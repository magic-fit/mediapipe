...
(cd mediapipe/magic/java/fit/magic/pose_tracking_magic && ./build-arm64.sh)

# Build .aar
rm -f build/mediapipe_pose_detection.aar
cp bazel-bin/mediapipe/magic/java/fit/magic/pose_tracking_magic/mediapipe_pose_detection.aar build/mediapipe-pose-detection.aar
